        ...
        resData && resData.map((val)=>{
          return(
              ...
              <section className='flex flex-row justify-around items-center pt-2'>
                ...
                <div className='relative'>
                  <span className='text-sm md:text-[8px]'>
                    {Math.abs(parseInt(val.departureTime)-parseInt(val.arrivalTime))} h 0 min
                    </span>
            ...
            <div className='flex flex-col p-2'>
              ...
              <button type="button" className="flightDetailsButton" onClick={openModal}>View details</button>
      
              <div className='mt-[0.8rem]'>
                    <Modal open={open} onClose={closeModal} style={{margin:"0",padding:"0"}}>
                      <h2 className='my-3 font-bold text-lg'>Your flight to Dubai</h2>
                      ...
                      <div className='flex justify-between mt-4'>
                        <div>
                          <div className='flex gap-1 items-center'>
                            <p className='font-bold'>INR21,561.00</p>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-4 h-4 '>
